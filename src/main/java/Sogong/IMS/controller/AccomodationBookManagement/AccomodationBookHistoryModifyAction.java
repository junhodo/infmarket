...
public class AccomodationBookHistoryModifyAction implements Action {
        ...
        try {
           ...
           if(isOk){
            AccomodationBookHistoryDAO accBookDAO = new AccomodationBookHistoryDAO();
                isOk = accBookDAO
                        .modify(AccomodationBookHistory.builder().accomodationBookHistoryID(accomodationBookHistoryID)
